...
function Overview({ ballots, connected, onVote, onCreate, onSection }: { ballots: Ballot[]; connected: boolean; onVote: (ballot: Ballot) => void; onCreate: () => void; onSection: (section: Section) => void }) {
  ...
  return <>
    ...
    <section className="metric-grid"><div className="metric-card"><div className="metric-icon mint"><Activity size={18} /></div><span>Active ballots</span><strong>12</strong><small>Demo data</small></div><div className="metric-card"><div className="metric-icon violet"><ShieldCheck size={18} /></div><span>Verified votes</span><strong>4,286</strong><small>Demo data</small></div><div className="metric-card"><div className="metric-icon blue"><LockKeyhole size={18} /></div><span>Tally during voting</span><strong>Sealed</strong><small>Enforced by the contract</small></div><div className="metric-card network-card"><div className="metric-network-line"><span className="pulse-dot" /> Midnight testnet <span className="network-live">Operational</span></div><div className="network-bar"><span /><span /><span /><span /><span /><span /><span /><span /></div><small>Last block <strong>1,928,441</strong> · Demo data</small></div></section>
